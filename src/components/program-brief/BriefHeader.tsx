      ...
      <div className="relative z-10 space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5 pt-1">
          ...
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white border border-slate-200 shadow-sm">
            ...
            <div>
              <div className="text-xs font-black text-slate-900 font-heading">10</div>
              <div className="text-[10px] text-slate-500 leading-tight">Hours / Week</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white border border-slate-200 shadow-sm">
            ...
            <div>
              <div className="text-xs font-black text-slate-900 font-heading">2</div>
              <div className="text-[10px] text-slate-500 leading-tight">Hours Weekly Test</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white border border-slate-200 shadow-sm">
            ...
            <div>
              <div className="text-xs font-black text-slate-900 font-heading">Portfolio Ready</div>
              <div className="text-[10px] text-slate-500 leading-tight">Projects</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white border border-slate-200 shadow-sm">
            ...
            <div>
              <div className="text-xs font-black text-slate-900 font-heading">Certificate of</div>
              <div className="text-[10px] text-slate-500 leading-tight">Completion</div>
            </div>
          </div>
        </div>
      </div>
