    ...
    <aside className="w-full lg:w-64 flex-shrink-0 flex flex-col justify-between space-y-6">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-900/90 border border-slate-800 shadow-md">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-tr from-blue-700 to-sky-400 flex items-center justify-center text-white flex-shrink-0 shadow-md">
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
              <path d="M4 19h16v2H4zM4 10h4v7H4zm6-5h4v12h-4zm6 3h4v9h-4z" />
            </svg>
          </div>
          <div>
            <h3 className="text-xs font-black text-white font-heading uppercase leading-tight">
              DATA SCIENCE
            </h3>
      ...
      {/* Motivational Climber Card with real AI generated image */}
      <div className="relative rounded-2xl overflow-hidden border border-slate-800 bg-slate-950 p-5 text-left shadow-xl min-h-[220px] flex flex-col justify-end">
        {/* Background Image */}
        <Image
        ...
        <div className="relative z-10">
          ...
          <p className="text-[11px] text-slate-300 leading-relaxed mt-1 mb-3">
