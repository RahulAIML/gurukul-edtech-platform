...
export const BriefFooterCta: React.FC = () => {
  const briefFeatures = [
    ...
    { label: 'Real-world Projects', desc: 'Build Your Portfolio', icon: Briefcase, color: 'text-red-600' },
    ...
    { label: 'Community Access', desc: 'Learn, Connect, Grow', icon: Award, color: 'text-red-700' },
  ];
  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-6 rounded-2xl bg-gradient-to-r from-red-50 via-white to-sky-50 border border-slate-200 shadow-card">
